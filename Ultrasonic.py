...
#     sensor_fright = DistanceSensor(ULT_RIGHT_ECHO, ULT_RIGHT_TRIG)
#     sensor_fleft = DistanceSensor(ULT_LEFT_ECHO, ULT_LEFT_TRIG)
#     sensor_right = DistanceSensor(ULT_BACK_RIGHT_ECHO, ULT_BACK_RIGHT_TRIG)
#     sensor_left = DistanceSensor(ULT_BACK_LEFT_ECHO, ULT_BACK_LEFT_TRIG)
#     return sensor_front.distance*100, sensor_fright.distance*100, sensor_fleft.distance*100, sensor_left.distance*100, sensor_right.distance*100
...
class UltrasonicSensor:
    ...
    def detect_obstacle(self):
        """Returns new required trajectory in order to avoid obstalcle as per sensor readings"""
